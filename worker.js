...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/" || url.pathname === "") return new Response(ROOT, {headers:{"content-type":"text/html; charset=utf-8"}});
    if (url.pathname === "/reservar" || url.pathname === "/reservar/") return new Response(RESERVAR, {headers:{"content-type":"text/html; charset=utf-8"}});
    if (url.pathname === "/gestion" || url.pathname === "/gestion/") return new Response(GESTION, {headers:{"content-type":"text/html; charset=utf-8"}});
